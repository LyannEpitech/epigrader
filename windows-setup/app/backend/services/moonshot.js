...
exports.MoonshotService = void 0;
...
class MoonshotService {
     ...
     */
    async analyzeCriterion(criterion, repoFiles) {
        try {
     ...
     */
    compressContent(content, filePath) {
     ...
     */
    buildPrompt(criterion, repoFiles) {
...
## Response (JSON only):
{
  ...
  "references": [{"file": "<path>", "lines": [<start>, <end>]}]
     ...
     */
    parseResponse(criterion, content) {
        try {
...
exports.MoonshotService = MoonshotService;
exports.default = MoonshotService;
